...
const BUSINESS_NAME = "Plant City Fence Builders";
const SITE_URL = "https://plantcityfencebuilders.com";
const TAGLINE = "Quality Fencing You Can Trust";
const PHONE_DISPLAY = "(813) 652-0559";
const PHONE_TEL = "tel:+18136520559";
const PHONE_RAW = "8136520559";
const EMAIL = "";
const CLIENT_EMAIL = "";
...
const STATE = "Florida";
const STATE_ABBR = "FL";
const COUNTY = "Hillsborough County";
const REGION = "Tampa Bay";
const GEO_LAT = 28.0186;
const GEO_LNG = -82.1196;

const PRIMARY_COLOR = "#2D5F3A";
const PRIMARY_DARK = "#1A3A23";
const SECONDARY_COLOR = "#D4C8B0";
const ACCENT_COLOR = "#C44536";
const OVERLAY_COLOR = "45, 95, 58"; // RGB values of PRIMARY_COLOR for rgba() overlays
...
const SERVICES = [
  ...
  { name: "Farm & Ranch Fence", slug: "farm-and-ranch-fence" },
